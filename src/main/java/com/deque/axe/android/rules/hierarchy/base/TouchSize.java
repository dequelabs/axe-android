...
public abstract class TouchSize extends ActiveView {
  ...
  public void collectProps(AxeView axeView, AxeProps axeProps) {
    ...
    axeProps.put(AxeProps.Name.IS_RENDERED, axeView.isRendered(axeDevice.dpi, axeDevice.screenHeight, axeDevice.screenWidth));
    axeProps.put(AxeProps.Name.IS_OFF_SCREEN, axeView.isOffScreen(axeView.boundsInScreen, axeDevice.screenHeight, axeDevice.screenWidth));
    axeProps.put(AxeProps.Name.IS_PARTIALLY_VISIBLE, axeView.isPartiallyVisible(axeView.boundsInScreen, axeDevice.screenHeight, axeDevice.screenWidth));
  ...
  public String runRule(AxeProps axeProps) {
    ...
    final boolean isPartiallyVisible = axeProps.get(AxeProps.Name.IS_PARTIALLY_VISIBLE, Boolean.class);
